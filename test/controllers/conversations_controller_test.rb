...
class ConversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation" do
    assert_difference('Conversation.count') do
      post conversations_url, params: { conversation: { admin_id: @conversation.admin_id, user_id: @conversation.user_id } }
    end
  ...
  test "should update conversation" do
    patch conversation_url(@conversation), params: { conversation: { admin_id: @conversation.admin_id, user_id: @conversation.user_id } }
